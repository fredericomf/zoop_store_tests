...
describe('SearchProductsComponent', () => {
  ...
  it('should fetch more products on scroll', fakeAsync(() => {
    productsMock.push(
  ...
  it('should fetch products when search text is provided', fakeAsync(() => {
  ...
  it('should fetch products when search text is empty', fakeAsync(() => {
